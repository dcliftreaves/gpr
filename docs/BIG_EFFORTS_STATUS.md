...
- `tools/cnn/train_premium_still_sr_raw_cfa_residual.py` now trains a
  ...
  feature probe, multiscale band-loss objective probe, and X2D-only
  train-domain filter remain negative. Those
  ...
  combined local-feature concatenation, simple band-loss reweighting, or
