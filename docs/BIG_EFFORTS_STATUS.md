...
- `tools/cnn/train_premium_still_sr_raw_cfa_residual.py` now trains a
  ...
  small U-Net alone, frame-context scalar planes alone, or bounded full-crop
  sampling alone:
