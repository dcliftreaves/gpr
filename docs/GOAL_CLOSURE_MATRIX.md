...
| Premium still/SR | 60% | Still-SR datasets, raw-CFA targets, routed specialists, editor-openability receipts, promotion tooling, and 95 runtime-safe experiment receipts. | A no-REF 50 MP / 100 MP candidate that beats the current still baseline and clears the promotion gate. Current best older runtime-safe recovery is 4.03% MAE / 3.75% RMSE against the 15% / 15% floor; the newest t64 Restormer degradation/objective receipts also fail the joint X2D/Z8 holdout gate. |
