...
| Pi 5 regression probe | `docs/LABS_PI_CAPTURE_REGRESSION_2026-06-15.md` records current, historical-doc, environment, runtime-knob, compiler-flag, quality, highpass-bound, timing, producer-guard, polynomial-log, u16 log-scratch, prescale-2 fixed-shift, lazy scratch allocation, prefetch, LUT-unroll, and luma-pair shared-unpack probes; best short direct-container near-miss is 23.54 fps median with luma-pair plus stripe64/deferred rANS, while diagnostic highpass dropping reaches 30.35 fps but is not valid output |
