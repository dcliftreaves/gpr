...
| What percentage done are the four product pillars? | `docs/PRODUCT_PILLAR_SCORECARD.md` and `/Volumes/OWC_8TB/gpr_work/artifacts/product_pillar_scorecard_coord_detail_review_20260701/index.html` |
