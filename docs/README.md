...
Where to look for what. Last refreshed 2026-05-28.
...
| open work items + priorities | `CHECKLIST_2026-05-28.md` |
...
| topic | doc |
|---|---|
| CNN-aware fine-grained compression (per-subband sweep) | `CNN_AWARE_REVIVAL_PLAN.md` |
...
| `pi5_bench_2026-05-26.md` | Pi 5 sustained-bench (manual) |
...
- `SESSION_SUMMARY_2026-05-27.md` — autonomous overnight session 2
...
| Multi-level FUSED regression saga | `REGRESSION_2026-05-25.md` |
