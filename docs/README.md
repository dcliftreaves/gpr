...
| `python3 tools/cnn/deduplicate_premium_still_sr_raw_targets.py --targets /Volumes/OWC_8TB/gpr_work/artifacts/premium_still_sr_raw_cfa_residual_targets_20260630/raw_cfa_residual_targets.npz --output-dir /Volumes/OWC_8TB/gpr_work/artifacts/premium_still_sr_raw_cfa_residual_targets_dedup_<date>` | collapse rendered EV duplicates into one raw-supervision row per scene/crop/source/candidate before the next premium still-SR teacher pass |
