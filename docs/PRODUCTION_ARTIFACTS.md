...
| Premium still-SR rejected relaunch guard JSON | `artifacts/premium_still_sr_rejected_relaunch_guard_20260702/preflight_audit.json` | `9704fada01ca037bfdd6fa839a953425c2a9502ff05cdb0ed7a1baaca7dd3320` |
| Premium still-SR rejected relaunch guard dashboard | `artifacts/premium_still_sr_rejected_relaunch_guard_20260702/index.html` | `83fd3f994f3e5b9319e22db048c863f6e47ae3079daf92f934e15402317343ab` |
| Premium still-SR window-attention candidate preflight JSON | `artifacts/premium_still_sr_candidate_preflight_window_attention_20260702/candidate_preflight.json` | `d67d26871da067a2698984a730a32394d3ae143db0230f65a14f4d81f11a954b` |
| Premium still-SR window-attention candidate preflight audit | `artifacts/premium_still_sr_candidate_preflight_window_attention_20260702/preflight_audit.json` | `da15fb5cac086c561acc80e7bbed920c87e00bca9a241821d33782f0b4b6d90b` |
| Premium still-SR window-attention candidate preflight dashboard | `artifacts/premium_still_sr_candidate_preflight_window_attention_20260702/index.html` | `72692e7baa6f0db83f4c231c5177466ec8a8541e2507b05033717b8352612277` |
| Premium still-SR window-attention launch packet JSON | `artifacts/premium_still_sr_launch_packet_window_attention_20260702/launch_packet.json` | `d6e6e3ba4ac413e72d7aa2192210aedfffe3a8132903d6cb2fe9a0cb23808491` |
| Premium still-SR window-attention launch packet dashboard | `artifacts/premium_still_sr_launch_packet_window_attention_20260702/index.html` | `72692e7baa6f0db83f4c231c5177466ec8a8541e2507b05033717b8352612277` |
| Premium still-SR window-attention X2D smoke rejection receipt | `artifacts/premium_still_sr_window_attention_smoke_x2d_20260702/train_receipt.json` | `e28add83f6653cfb73e4692eff462ff7c3933c6b8613c3313535bfedd41b2ed0` |
| Premium still-SR window-attention X2D smoke rejection dashboard | `artifacts/premium_still_sr_window_attention_smoke_x2d_20260702/index.html` | `1b00ba69fd5955600af0bd10a59182b4e6562c0d2573cdb2afff0b2e901d4e68` |
| Premium still-SR window-attention Z8 smoke rejection receipt | `artifacts/premium_still_sr_window_attention_smoke_z8_20260702/train_receipt.json` | `828f0d90d86aaa57557a58147f38fde096efa828d457eab593daadc44cdbe227` |
...
| Premium still-SR source-evidence split candidate preflight | `artifacts/premium_still_sr_candidate_preflight_source_evidence_split_20260702/candidate_preflight.json` | `7c2928aaa7906fba9795bf68d14ac033bbac73942396aa0fbb15899e83a2b635` |
| Premium still-SR source-evidence split preflight audit | `artifacts/premium_still_sr_launch_packet_source_evidence_split_20260702/preflight_audit.json` | `9a7aa461d8f66d3aef76a71bc78a57b7370ab65fdd5f39c0e1dc371c5d77addc` |
| Premium still-SR source-evidence split launch packet | `artifacts/premium_still_sr_launch_packet_source_evidence_split_20260702/launch_packet.json` | `bc344fe21552859bbad4041ea27db5e6aedea4c495d8a35a7c5fa273b72e967d` |
| Premium still-SR source-evidence split launch packet Markdown | `artifacts/premium_still_sr_launch_packet_source_evidence_split_20260702/launch_packet.md` | `d04b24dd7ce816d1ce1f48d40c29e39065a450969378e167c3fd53350bb81367` |
...
| Premium still-SR source-evidence split X2D smoke receipt | `artifacts/premium_still_sr_source_evidence_split_teacher_x2d_smoke_20260702_next/train_receipt.json` | `cc3b4226a71cea76a9ca0018dcb07b0c8c1d44f0f4d66ee02c628386fe6be033` |
...
| Premium still-SR route-specialist readiness with rendered review receipt | `artifacts/premium_still_sr_route_readiness_with_rendered_20260702/route_readiness.json` | `221fef0c7d7193576c0209680172e34e1638f2b4311f4d9622ab2d39963c2536` |
| Premium still-SR route-specialist readiness with rendered review dashboard | `artifacts/premium_still_sr_route_readiness_with_rendered_20260702/index.html` | `7386f06f1bdf3e0d1d4f650c47372cfac2b0e2725d6d89a737a3bcc56dd00b4b` |
| Premium still-SR editor/latitude route coverage receipt | `artifacts/premium_still_sr_editor_latitude_coverage_20260702/coverage.json` | `15e278f4b8e5374bccefd574729dad465a3be52c5182b9c1334915fbc7c08e6e` |
| Premium still-SR editor/latitude route coverage dashboard | `artifacts/premium_still_sr_editor_latitude_coverage_20260702/index.html` | `5844f43654085f8237e24cd667a56d11f3b6fe85016a511edcaaec5878570064` |
| Premium still-SR Mission 1 DNG editor receipt | `artifacts/premium_still_sr_editor_route_packaging_20260702/mission1_dng/editor_receipt/editor_receipt.json` | `5d5ca760ce5ee879b21a992adf27a81a45714676f08c2df9904421d2f75b6e5e` |
| Premium still-SR Mission 1 GPR editor receipt | `artifacts/premium_still_sr_editor_route_packaging_20260702/mission1_gpr/editor_receipt/editor_receipt.json` | `f9411c52e50b46f260663eba03f8a6270ada2ede806321b006998fb46fdaa0f3` |
| Premium still-SR Z8 DNG editor receipt | `artifacts/premium_still_sr_editor_route_packaging_20260702/z8_dng/editor_receipt/editor_receipt.json` | `8ba96689b66445462823a7ede9697eb2f2d6dff0305b8242c77069a1be124213` |
| Premium still-SR Mission 1 DNG latitude receipt | `artifacts/premium_still_sr_editor_route_packaging_20260702/mission1_dng/latitude_review/latitude_review.json` | `73f8f45101a5de48dcaff616bebf67967e4ba6021e386b497f884d8b5facd9ce` |
| Premium still-SR Mission 1 GPR latitude receipt | `artifacts/premium_still_sr_editor_route_packaging_20260702/mission1_gpr/latitude_review/latitude_review.json` | `d8174a92c3735f6ed7017c801945ee63304a03f50923aa326931d84bcd82c5f7` |
| Premium still-SR Z8 DNG latitude receipt | `artifacts/premium_still_sr_editor_route_packaging_20260702/z8_dng/latitude_review/latitude_review.json` | `a706697a00c919ae30ddb7761708c655b45552d8bde7a6e6a5ab91961f361a31` |
| Premium still-SR X2D non-oracle raw-editor latitude receipt | `artifacts/premium_still_sr_x2d_latitude_review_no_oracle_20260702/latitude_review.json` | `2a999ef852a773ac0aa953368e8889ea04cc06a3f00a867f13291dfa9ce1db22` |
| Premium still-SR X2D non-oracle raw-editor latitude dashboard | `artifacts/premium_still_sr_x2d_latitude_review_no_oracle_20260702/index.html` | `20afc5ea2e45922aceea227dd3112f14c085cde58204fa80ca50854d754c1559` |
| Premium still-SR routed rendered EV-stress proxy review receipt | `artifacts/premium_still_sr_rendered_review_routed_20260630/rendered_review.json` | `4f46ae35f0124e1dfbaf5331a73586657712c26de7a11bb5f8bc74307d7c0be3` |
| Premium still-SR routed rendered EV-stress proxy dashboard | `artifacts/premium_still_sr_rendered_review_routed_20260630/index.html` | `f5fe20d411c0e8231e887e931891590040cb4a4dcc6d17f60febfdb1ce3d8b64` |
| Premium still-SR routed rendered EV-stress proxy contact sheet | `artifacts/premium_still_sr_rendered_review_routed_20260630/rendered_latitude_contact_sheet.jpg` | `9486b3b47ca80fe67e22524c6c9a549197ba6e7b6d6f137ce9dce9d58644673e` |
