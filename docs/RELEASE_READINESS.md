...
- Gate17 closed Premium still/SR target construction with 576 50 MP and 576
  100 MP rows, then rejected the first unmodified raw-CFA residual checkpoint
  ...
  no-op. The next local work is Gate19 positive-signal/source revision, not
  another unchanged Gate17 run or safety-only Gate18 rerun.
