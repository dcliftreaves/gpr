...
| Broad real-camera Bayer phase coverage | Synthetic conformance covers RGGB/GBRG/GRBG/BGGR, but real local fixtures currently cover RGGB and GBRG. | Real GRBG and BGGR DNG/GPR fixtures with metadata, black/white levels, extraction receipt, still matrix/capability evidence, and compatibility docs updated. |
...
remaining work is specific: real Mission 1 camera-role receipts, real missing
Bayer-phase fixtures, Mission/iPhone noise sidecars, promotable premium
still-SR, and controlled PSF evidence for a better video/SR model.
