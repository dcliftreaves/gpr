...
| Current half-res variant probe | `docs/LABS_PI_CAPTURE_REGRESSION_2026-06-15.md` reports current encoder knobs; best stable probe is 21.23 fps median and producer unpack aborts | regression evidence |
