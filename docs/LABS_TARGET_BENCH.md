...
| Mission 1 still source corpus | `/Volumes/Photos/DavidsPics/gopro_raw/2026-06__GoProM1P/GoProMission1` contains 40 Mission 1 `.GPR` files at 8192 x 6144, 16-bit RGGB, plus 4 HERO10 files excluded from Mission 1 receipts. The `DNG/` subdir contains 40 matching Mission 1 DNG conversions plus 2 HERO10 DNGs. Inventory and decode smoke live at `/Volumes/OWC_8TB/gpr_work/artifacts/mission1_source_inventory_20260615/summary.json`; `GP017517.GPR` decodes to RAW with SHA-256 `8ab2a9772cc813b2036e30c122315ae605111ef2c14be6dab004c5de5ad44f03`. `GP017517.dng` exposes black level 16, white level 16383, gain maps, and NoiseProfile; its RAW extraction differs from `.GPR` RAW only by 0/-1 LSB, so use `.GPR` RAW for timing receipts and DNG metadata for noise/profile work. Current `gpr_tools` parameter dump and DNG->GPR paths throw `dng_exception` and need compatibility work. | real source corpus; file-backed target input ready |
