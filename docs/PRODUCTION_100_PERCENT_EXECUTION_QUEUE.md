...
`-35.30304893327897%`, and 50 MP worst MAE `-2.259351982942634%`. The remaining
blockers are Gate19 positive-signal/source revision, broad target-row audit
pass, full 50 MP / 100 MP gate rows, timing/memory, exact noise-policy wiring,
and production submission.
