...
| RAW video PSF/SR improvement | **52%** | The coord/detail PSF-focus continuation is now registered for review, beats the previous focused baseline on paired Mission42/Z8 RMSE/PSNR floors, and has refreshed decode/SR, editable raw, ProRes, and metadata receipts; controlled PSF pairs plus full-sequence production packaging/audit receipts remain open. |
