...
| **4. PSF-aware video improvement** | 4K cleanup and 8K reconstruction that model the real blur from Bayer resize/capture instead of generic sharpening. | Approved 4K cleanup and 8K SR baselines are available for post; a coord/detail PSF-focus continuation is now registered for review after beating the previous focused baseline on Mission42/Z8 RMSE/PSNR floors, but controlled high/low PSF captures and a refreshed production package remain open. |
...
Current four-pillar completion is **71%**. This is a production-readiness burn-down, not an image-quality score, and not a regression signal for locked artifacts.
...
| RAW video PSF/SR improvement | **50%** | The coord/detail PSF-focus continuation is now registered for review and beats the previous focused baseline on paired Mission42/Z8 RMSE/PSNR floors; controlled PSF pairs and refreshed production packaging/audit receipts remain open. |
...
| Four-pillar production burn-down | `/Volumes/OWC_8TB/gpr_work/artifacts/product_burndown_coord_detail_review_20260701/index.html` |
