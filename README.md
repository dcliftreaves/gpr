...
| **Premium still/SR** | **60%** | Raw-CFA targets, routed specialists, model-promotion tooling, the 124-receipt experiment scoreboard, X2D/Z8 source-evidence audits, rejected clean-source/frequency-pyramid/gated-residual/masked-detail/raw-CFA source-frequency/raw-CFA residual-signal/candidate-HF no-op/route-conditioned noise-aware smoke receipts, a target/degradation blocker receipt, a replacement target/source contract, Gate 10 source/degradation decision, failed Gate 11 route-isolated teacher/router smoke, Gate 12 measured/synthetic teacher-source audit/intake/smoke, Gate 13 source/objective revision, Gate 14 executable selector intake, route-specialist readiness audit, routed rendered EV-stress proxy review, and 4/4 editor/latitude coverage now exist. | Route-specialist full-frame metrics are positive. Editable DNG/GPR openability and non-oracle raw-editor latitude are proven for Mission 1 DNG, Mission 1 GPR, Z8 DNG, and X2D DNG. The exact-sidecar-only noise policy passes and Gate 14 persists a seven-rule candidate-only selector sidecar, but no model receipt clears the 15% / 15% promotion floor or production submission validation. Next work is Gate 14 selector smoke through the actual model-loading/render path. |
...
| **Premium still/SR** | 124 runtime-safe experiment receipts, raw-CFA targets, routed specialists, promotion tooling, X2D/Z8 source-evidence audits, rejected clean-source/frequency-pyramid/gated-residual/masked-detail/route-conditioned noise-aware receipts, Gate 10 source/degradation decision, failed Gate 11 route-isolated smoke, Gate 12 source audit, Gate 12 candidate intake, failed Gate 12 paired smoke, Gate 13 source audit, Gate 13 tail-safe smoke, Gate 13 feature-rich tail-safe smoke, Gate 13 multi-source source/objective revision, Gate 14 executable selector intake, route-specialist readiness evidence, routed rendered EV-stress proxy evidence, 4/4 non-oracle editor/latitude coverage, and exact-sidecar clean-target policy exist. | Current candidates are not promotable; next evidence is `premium_still_sr_gate14_selector_smoke_<date>` proving the sidecar reproduces the intake pass through the actual model-loading/render path from candidate-only runtime inputs. |
