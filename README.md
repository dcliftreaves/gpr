...
The current scoreboard is deliberately not promotable: **93** runtime-safe
...
**15% / 15%** promotion floor, and newer clean-source Restormer pair receipts
that still fail the joint X2D/Z8 holdout gate.
...
| Premium still-SR experiment scoreboard | `/Volumes/OWC_8TB/gpr_work/artifacts/premium_still_sr_experiment_scoreboard_restormer_t64_20260702/index.html` |
