...
def main() -> int:
    ...
    for rel in (
        ...
        "tools/build_production_capture_submission_template.py",
        ...
        "tools/test/test_build_production_capture_submission_template.py",
    ...
    require_text("docs/PRODUCTIZATION_CONTRACTS.md", [
        ...
        "RAW video cleanup and reconstruction, with PSF-aware replacement work kept",
        ...
        "docs/PRODUCTION_CAPTURE_REQUIREMENTS.md",
        "docs/PRODUCTION_CAPTURE_REQUIREMENTS.json",
        "real fixtures, darkframes, camera receipts, and model-promotion receipts",
        "Controlled PSF pairs remain listed as optional",
        "real_grbg_fixture",
