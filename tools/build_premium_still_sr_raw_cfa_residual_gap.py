...
<main>
  ...
  <table><thead><tr><th>Camera</th><th>Holdout</th><th>Features</th><th>Target policy</th><th>MAE recovery</th><th>RMSE recovery</th><th>Runtime safe</th><th>Promote</th></tr></thead><tbody>{model_rows}</tbody></table>
