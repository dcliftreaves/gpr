    ...
    pillars = [
        ...
        },
        {
            ...
            "done_evidence": [
                ...
                "Follow-up X2D probes show a wider/block17 model barely clears zero at about 0.02 percent median recovery, while stored candidate-HF features, naive one-sigma noise soft-thresholding, and larger-patch high-residual-weighted local training remain negative. This is blocker evidence rather than a production checkpoint.",
            ],
            "open_work": [
                "Replace the weak first raw-CFA residual learner with a non-local raw-context model/objective that clears both Z8 and X2D held-out raw-residual gates; the current blocker is X2D/domain generalization and low recovery, not target construction, stored-HF features, naive noise subtraction, or local loss-weight tuning.",
        ...
        },
        {
            ...
            "evidence": annotate_refs(
                [
                    ...
                    artifact_ref("continuous 8K no-CNN vs CNN ProRes review", "artifacts/z8_continuous_8k_no_cnn_vs_cnn_20260630/receipt.json"),
