    ...
    pillars = [
        ...
        },
        {
            ...
            "done_evidence": [
                ...
                "The PSF detail-metric audit confirms Mission42 and Z8 all24 baseline/candidate summary coverage is present, but the selected summaries are missing same-cell Bayer fine-detail metrics needed for PSF-conditioned promotion.",
            ],
            "open_work": [
                ...
                "Add same-cell Bayer detail metrics to the full-frame Mission/Z8 summary builders and re-run the SR/detail scoreboard.",
            ...
            "evidence": annotate_refs(
                [
                    ...
                    artifact_ref("raw-video PSF detail metric audit", "artifacts/raw_video_psf_detail_metric_audit_20260701/index.html"),
                ],
                external_root,
            ),
        },
