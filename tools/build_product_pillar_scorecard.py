...
def build_scorecard(external_root: Path) -> dict[str, Any]:
    pillars = [
        {
            ...
            "done_evidence": [
                ...
                "The stills fixture gap plan now reports all real normal Bayer phases ready and identifies the lowest-lift Mission darkframe top-up: ISO232 RGGB has two candidates and needs two more matching frames.",
                "The raw-stills capture request now asks only for Mission 1 and iPhone darkframe stacks, with validation commands and promotion criteria.",
            ],
            "open_work": [
                "Fulfill the raw-stills capture request: collect or locate same-ISO Mission 1 and CFA iPhone darkframe stacks.",
            ...
            "evidence": annotate_refs(
                [
                    ...
                    artifact_ref("stills fixture gap plan", "artifacts/stills_fixture_gap_plan_20260701/index.html"),
                    artifact_ref("raw-stills capture request", "artifacts/stills_capture_request_20260701/index.html"),
    ...
    return {
        ...
        "next_actions": [
            ...
            "Fulfill the raw-stills capture request: collect same-ISO Mission 1/CFA iPhone darkframes before promoting nonzero noise addback; the current lowest-lift Mission top-up is ISO232 RGGB with two matching frames still needed.",
