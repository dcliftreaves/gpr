    ...
    pillars = [
        ...
        },
        {
            ...
            "done_evidence": [
                ...
                "The first true raw-CFA residual trainer now runs against that NPZ with candidate-only runtime inputs. A stabilized w32/2000-step pass is mildly positive on held-out Z8 at about 0.50 percent median raw-residual MAE recovery, but held-out X2D remains negative at about -0.21 percent, so this is blocker evidence rather than a production checkpoint.",
            ],
            "open_work": [
