    ...
    pillars = [
        {
            ...
            "done_evidence": [
                ...
                "The broad Mission/iPhone darkframe candidate audit parses 650 real DNGs, finds 58 dark-like frames and three iPhone same-ISO candidate stacks, but keeps production sidecar readiness false because candidate-discovery scene frames still need confirmed no-scene-signal provenance.",
                "The stills fixture gap plan now reports all real normal Bayer phases ready and identifies per-family lowest-lift paths: Mission ISO232 RGGB has two candidates and needs two more matching frames; iPhone ISO1250 RGGB has 23 dark-like candidates but needs no-scene provenance before promotion.",
            ...
            "evidence": annotate_refs(
                [
                    ...
                    artifact_ref("Mission/iPhone broad darkframe candidate audit", "artifacts/darkframe_candidate_audit_mission_iphone_broad_20260701/index.html"),
                    artifact_ref("targeted Mission DNG darkframe scan", "artifacts/darkframe_candidate_audit_targeted_dng_20260630/index.html"),
                    artifact_ref("stills fixture gap plan", "artifacts/stills_fixture_gap_plan_noise_broad_20260701/index.html"),
                    artifact_ref("raw-stills capture request", "artifacts/stills_capture_request_noise_broad_20260701/index.html"),
        ...
        },
        {
            ...
            "open_work": [
                "Follow the next-experiment contract: replace the weak first raw-CFA residual learner with a full-image or structured raw-context model/objective that clears both Z8 and X2D held-out raw-residual gates; the current blocker is X2D raw-detail recovery strength, not target construction, stored-HF features, naive noise subtraction, local loss-weight tuning, simple pooled-context feature concatenation, combined local-feature concatenation, multiscale band-loss reweighting, camera-domain filtering, camera-balanced sampling, 32px context padding, a small U-Net alone, frame-context scalar planes alone, bounded full-crop sampling alone, bounded full-crop stored-HF/context U-Net training, bounded full-crop spectral-loss U-Net training, larger full-crop raw-context U-Net training, deeper gated pyramid U-Net training, bounded global-context U-Net training, or nearest-neighbor residual patch retrieval over current candidate features.",
