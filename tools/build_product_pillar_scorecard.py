    ...
    pillars = [
        ...
        },
        {
            ...
            "done_evidence": [
                ...
                "The refreshed next-experiment contract now locks the next premium still-SR pass to the canonical 351-row / 13-scene raw-CFA residual target, forbids REF/source/JPEG content at render time, and points the next primary model pass toward a SwinIR/HAT-style window-attention or Restormer-style high-resolution raw teacher/student with full-image or overlapped-tile validation instead of another local CNN sweep.",
            ...
            "evidence": annotate_refs(
                [
                    ...
                    artifact_ref("premium still-SR next-experiment contract", "artifacts/premium_still_sr_next_experiment_contract_transformer_teacher_20260701/index.html"),
