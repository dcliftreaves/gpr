    ...
    pillars = [
        ...
        },
        {
            ...
            "done_evidence": [
                ...
                "The refreshed premium still-SR experiment scoreboard now scans 93 rendered-HF, raw-CFA residual, clean-signal, and clean-source pair training receipts. It records 93 runtime-safe rows, zero promotable rows, and a best older runtime-safe holdout of 4.03 percent MAE / 3.75 percent RMSE recovery, far below the 15 percent / 15 percent promotion threshold. The newest t64 Restormer clean-source pair receipts also fail: X2D smoke is only about +0.013 percent median MAE recovery, Z8 smoke is about -0.072 percent, and the longer Z8 pass overfits train while regressing held-out MAE to about -5.06 percent.",
            ],
            "open_work": [
            ...
            "evidence": annotate_refs(
                [
                    ...
                    artifact_ref("premium still-SR experiment scoreboard", "artifacts/premium_still_sr_experiment_scoreboard_restormer_t64_20260702/index.html"),
