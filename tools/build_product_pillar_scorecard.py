    ...
    pillars = [
        ...
        },
        {
            ...
            "done_evidence": [
                ...
                "The coord/detail PSF-focus step-75 continuation is now registered for review as mission1_native12_8k_sr_coord_detail_psf_focus_step0075_v1. It beats the previous psf-gradient-focus baseline on paired Mission42 and regenerated Z8 RMSE/PSNR floors, and now has registry-driven .gvid decode-to-SR, editable DNG/GPR, 2K ProRes, Mission metadata-transplant receipts, 42-frame full-sequence .gvid packaging, continuous 8K ProRes review, objective visual-review, and blocked production-audit receipts. It still needs manual whole-scene visual signoff and controlled native PSF evidence before promotion.",
            ],
            "open_work": [
                ...
                "Complete manual whole-scene visual signoff for the coord/detail PSF-focus step-75 candidate if it remains the preferred review candidate.",
