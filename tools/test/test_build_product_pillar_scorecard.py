...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="gpr_product_pillar_scorecard_") as tmp:
        ...
        assert data["four_pillar_completion_percent"] == 65
        ...
        assert data["pillars"][2]["readiness_percent"] == 47
        assert data["pillars"][3]["readiness_percent"] == 43
