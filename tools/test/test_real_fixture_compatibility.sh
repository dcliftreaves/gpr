...
MISSION1_50_DNG="${MISSION1_50_DNG:-}"
MISSION1_12_DNG="${MISSION1_12_DNG:-}"
MISSION1_GPR="${MISSION1_GPR:-}"
...
IPHONE_CFA_DNG="${IPHONE_CFA_DNG:-}"
IPHONE_LINEAR_RAW_DNG="${IPHONE_LINEAR_RAW_DNG:-}"
