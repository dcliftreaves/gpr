...
def premium_still_sr_template() -> dict[str, Any]:
    return {
        "candidate_preflight_manifest_path": "<candidate_preflight.json>",
        "candidate_preflight_manifest_sha256": SHA_PLACEHOLDER,
        "candidate_preflight_audit_path": "<candidate_preflight_audit.json>",
        "candidate_preflight_audit_sha256": SHA_PLACEHOLDER,
        "candidate_preflight_launchable": True,
        "launch_packet_path": "<premium_still_sr_launch_packet.json>",
        "launch_packet_sha256": SHA_PLACEHOLDER,
        ...
        "x2d_smoke_receipt_path": "<x2d_smoke_receipt.json>",
        "x2d_smoke_receipt_sha256": SHA_PLACEHOLDER,
        "z8_smoke_receipt_path": "<z8_smoke_receipt.json>",
        ...
        "z8_smoke_worst_row_mae_reduction_pct": "<z8_smoke_worst_row_mae_reduction_pct>",
